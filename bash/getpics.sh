...
# download the tarfile to the Pitures directory if it isn't already there
...
# unpack the downloaded tarfile, if it is there, inside the ~/Pictures directory, then deletes the local copy of the zipfile
